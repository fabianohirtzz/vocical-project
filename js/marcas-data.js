...
(function () {
  var SERV = {
    ...
    orcamento: { t: 'Orçamento rápido', d: 'Resposta ágil para pedidos recorrentes e demandas pontuais.' },
    consultivo:{ t: 'Atendimento consultivo B2B', d: 'Apoio no quantitativo, alternativas de produto e orçamento técnico rápido.' },
    retira:    { t: 'Retira na unidade', d: 'Praticidade para compras recorrentes e urgências do dia a dia.' }
  };

  var EXTRA = {
    'vocical': {
      tagline: 'Tudo que você precisa, com quem abastece desde 1987',
    ...
    'jacical': {
      tagline: 'Do cimento ao aço, com quem entende de abastecimento',
    ...
    'distribuidoras': {
      tagline: 'Os essenciais do dia a dia com atendimento direto',
    ...
    'rp-cimento-cal': {
      tagline: 'Cimento, cal e os essenciais do dia a dia',
